...
export default function ReactCookieLibrary() {
    ...
    const onKValueChangeHandler = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    const onRegistButtonClickHandler = () => {
        ...
        // setCookie 함수는 첫번째 매개변수로 name 값 / 두번째 매개변수로 value 값 / 세번째 매개변수로 option 지정
        // option: 
    ...
    return (
        <div>
            ...
            <input onChange={onKValueChangeHandler} value={value} />
